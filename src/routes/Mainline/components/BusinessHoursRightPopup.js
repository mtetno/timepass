...
const BusinessHoursRightPopup = ({onEditBusinessHours,businessHoursTimezoneDDValues}) => {
  ...
  <table>
    ...
    <tr>
      <td>
        <table>
          <tbody><tr>
            <td id="hours-off" className="radio-sec simple-trans hours_on hours-on-option"><div className="radio"><div className="snappy"></div>
<input id="hours-off-inp" name="hours_on" type="radio"  value="false"/></div></td>
            <td className="bh-first-radio-label radio-label">24/7</td>
            <td id="hours-on" className="radio-sec simple-trans hours_off hours-on-option"><div className="radio checked"><div className="snappy"></div>
<input id="hours-on-inp" name="hours_on" type="radio"  value="true"/></div></td>
  ...
  <div className="mblock">
    <div className="timezone-menu"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="timezone" name="timezone" type="text" value={businessHoursTimezoneDDValues.selected_time_zone} className="snappy sm-input sm-item-value-US/Eastern " tabindex="-1"/>
  </div>
...

{
  businessHoursTimezoneDDValues.time_zone_drop_down.map((item)=>  <li className="sm-item" id={`sm-item-timezone-${item}`} data-value={item}>
      ...
      <a className={`sm-text sm-item-value-${item} `}   title= {item}>
        {item}
      </a>
    </li>)
}
  ...
  <div id="business-hours">
    ...
    <table className="business-hours ">
      ...
      <tr>
        ...
        <td className="bh-time" id="monday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="monday_start_time" name="monday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-monday_start_time-closed" data-value="closed" data-off="true">

      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="monday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="monday_end_time" name="monday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-monday_end_time-00:15" data-value="00:15">

      <a className="sm-text sm-item-value-00:15 " href="javascript:void(0)" title="12:15 am">
        ...
        <td className="bh-all-weekdays" id="business-all-weekdays"><div className="radio square mblock" id="div_b4e5_2">
<div className="snappy"></div>
<input id="input-all-weekdays" name="" type="checkbox"  value=""/>
</div></td>
        <td className="bh-checkbox-label">Same for all weekdays</td>
        <td className="bh-all-days" id="business-all-days"><div className="radio square mblock" id="div_b4e5_3">
<div className="snappy"></div>
<input id="input-all-weekdays" name="" type="checkbox"  value=""/>
</div></td>
      ...
      <tr>
        ...
        <td className="bh-time" id="tuesday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="tuesday_start_time" name="tuesday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-tuesday_start_time-closed" data-value="closed" data-off="true">
        ...
        <td className="bh-time" id="tuesday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="tuesday_end_time" name="tuesday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-tuesday_end_time-00:15" data-value="00:15">
      ...
      <tr>
        ...
        <td className="bh-time" id="wednesday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="wednesday_start_time" name="wednesday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-wednesday_start_time-closed" data-value="closed" data-off="true">
      ...
      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="wednesday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="wednesday_end_time" name="wednesday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-wednesday_end_time-00:15" data-value="00:15">
      ...
      <tr>
        ...
        <td className="bh-time" id="thursday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="thursday_start_time" name="thursday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-thursday_start_time-closed" data-value="closed" data-off="true">
      ...
      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="thursday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="thursday_end_time" name="thursday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-thursday_end_time-00:15" data-value="00:15">
      ...
      <tr>
        ...
        <td className="bh-time" id="friday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="friday_start_time" name="friday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-friday_start_time-closed" data-value="closed" data-off="true">
      ...
      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="friday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="friday_end_time" name="friday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-friday_end_time-00:15" data-value="00:15">
      ...
      <tr>
        ...
        <td className="bh-time" id="saturday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="saturday_start_time" name="saturday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-saturday_start_time-closed" data-value="closed" data-off="true">
      ...
      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="saturday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="saturday_end_time" name="saturday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

            <li className="sm-item" id="sm-item-saturday_end_time-00:15" data-value="00:15">
      ...
      <tr>
        ...
        <td className="bh-time" id="sunday-start"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="sunday_start_time" name="sunday_start_time" type="text" value="11:00 am" className="snappy sm-input sm-item-value-11:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-sunday_start_time-closed" data-value="closed" data-off="true">
      ...
      <a className="sm-text sm-item-value-closed " href="javascript:void(0)" title="Closed">
        ...
        <td className="bh-time" id="sunday-end"><div className="select-menu-view"><div className="select-menu snappy  closed">
  <div className="sm-input-shim" tabindex="0">


    <input id="sunday_end_time" name="sunday_end_time" type="text" value="8:00 pm" className="snappy sm-input sm-item-value-20:00 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">

    <li className="sm-item" id="sm-item-sunday_end_time-00:15" data-value="00:15">
...
<div className="form-block">
  <div>
    ...
    <div className="sec-tabs">
      <div id="business-hours-tab" className="sec-tab-selected">Open hours routing<div className="iblock" id="tab-business-hours"></div></div>
      <div id="after-hours-tab" className="">Closed hours routing<div className="iblock" id="tab-after-hours"></div></div>
    </div>
...
<div id="div_b4e5_5">
  ...
  <div id="first_action-operators" className="simple-trans mblock center first_action call-handled selected">
    <table><tbody><tr><td>
      <div><div className="web-icon-xl web-icon-xl-operator"></div></div>
      <div id="action-operators"><div className="radio checked"><div className="snappy"></div>
<input id="operators-inp" name="first_action" type="radio"  value="operators" checked="true"/></div></div>
      <div className="center"><label for="operators-inp" className="radio-label selected">Operators</label></div>
    </td></tr></tbody></table>
  </div>

  <div id="first_action-menu" className="simple-trans mblock center first_action call-handled">
    <table><tbody><tr><td>
      <div><div className="web-icon-xl web-icon-xl-menu"></div></div>
      <div id="action-menu"><div className="radio"><div className="snappy"></div>
<input id="menu-inp" name="first_action" type="radio"  value="menu"/></div></div>
      <div className="center"><label for="menu-inp" className="radio-label" id="label_b4e5_0">
...
<div id="routing-options-operators">
  ...
  <div id="operator_routing-longestidle" className="simple-trans operator_routing selected">
    <table className="operator-routing">
      <tbody><tr>
        <td>
          <div id="operator_routing-chk-longestidle" className="mblock"><div className="radio checked"><div className="snappy"></div>
<input id="operator_routing-chk-inp-longestidle" name="operator_routing_type" type="radio"  value="longestidle" checked="true"/></div></div>
  ...
  <div id="operator_routing-fixedorder" className="simple-trans operator_routing">
    <table className="operator-routing">
      <tbody><tr>
        <td>
          <div id="operator_routing-chk-fixedorder" className="mblock"><div className="radio"><div className="snappy"></div>
<input id="operator_routing-chk-inp-fixedorder" name="operator_routing_type" type="radio"  value="fixedorder"/></div></div>
        </td>
        <td>
          <label for="operator_routing-chk-inp-fixedorder" className="radio-label">
            Fixed order
          </label>
        </td>
      </tr>
  ...
  <div id="operator_routing-roundrobin" className="simple-trans operator_routing">
    <table className="operator-routing">
      <tbody><tr>
        <td>
          <div id="operator_routing-chk-roundrobin" className="mblock"><div className="radio"><div className="snappy"></div>
<input id="operator_routing-chk-inp-roundrobin" name="operator_routing_type" type="radio"  value="roundrobin"/></div></div>
        </td>
        <td>
          <label for="operator_routing-chk-inp-roundrobin" className="radio-label">
            Round robin
          </label>
        </td>
      </tr>
  ...
  <div id="operator_routing-simultaneous" className="simple-trans operator_routing">
    <table className="operator-routing">
      <tbody><tr>
        <td>
          <div id="operator_routing-chk-simultaneous" className="mblock"><div className="radio"><div className="snappy"></div>
<input id="operator_routing-chk-inp-simultaneous" name="operator_routing_type" type="radio"  value="simultaneous"/></div></div>
        </td>
        <td>
          <label for="operator_routing-chk-inp-simultaneous" className="radio-label">
            Simultaneous
          </label>
        </td>
      </tr>
...
<table className="form" id="table_b4e5_0">
    ...
    <td id="td_b4e5_6" colspan="2">
      ...
      <div className="upload_complete">
        ...
        <div className="ccntr-call-handling-subview-holder">
          ...
          <div id="ring-duration-slider-view" ><div><div className="range-slider">
  <div className="rs-current-value" id="div_b4e5_7">30s</div>
  <div className="rs-bar" id="div_b4e5_8"></div>
  <input type="range" min="10" max="45" value="30"/>
  ...
  <div className="rs-max">45s</div>
        ...
        <div className="ccntr-call-handling-subview-holder">
          ...
          <div id="hold-queue-settings-view"><div><div id="group-hold-queue-setting" className="mblock"><div className="radio square mblock checked">
<div className="snappy"></div>
<input id="group-hold-queue-setting" name="enable_hold_queue" type="checkbox"  value=""/>
</div></div>
...
<div id="div_b4e5_10">
  ...
  <form id="max-hold-form" className="ivrgrp-hold-queue-section-details">
    ...
    <div>
      <input name="max-hold-count" id="max-hold-count" className="ccntr-input-field" type="number" min="0" value="3"/>
    ...
    <div className="max-hold-wait-time">
      <div>
        <input name="max-hold-minutes" id="max-hold-minutes" className="ccntr-input-field" type="number" min="0" max="300" step="1" value="5"/>
  ...
  <div className="sm-input-shim" tabindex="0">
    ...
    <input id="max-hold-seconds" name="max-hold-seconds" type="text" value="0" className="snappy sm-input sm-item-value-0 ccntr-input-field" tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">
        ...
        <li className="sm-item" id="sm-item-max-hold-seconds-0" data-value="0">
          ...
          <a className="sm-text sm-item-value-0 " href="javascript:void(0)" title="0">

            0
          </a>
        </li>

        <li className="sm-item" id="sm-item-max-hold-seconds-15" data-value="15">

          <a className="sm-text sm-item-value-15 " href="javascript:void(0)" title="15">

            15
          </a>
        </li>

        <li className="sm-item" id="sm-item-max-hold-seconds-30" data-value="30">

          <a className="sm-text sm-item-value-30 " href="javascript:void(0)" title="30">

            30
          </a>
        </li>

        <li className="sm-item" id="sm-item-max-hold-seconds-45" data-value="45">

          <a className="sm-text sm-item-value-45 " href="javascript:void(0)" title="45">
...
<table className="form" id="table_b4e5_1">
  ...
  <div className="sm-input-shim" tabindex="0">
    ...
    <input id="customivr" name="customivr" type="text" value="Default Hold Intro" className="snappy sm-input sm-item-value-default " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">
        ...
        <li className="sm-item" id="sm-item-customivr-default" data-value="default">
          ...
          <a className="sm-text sm-item-value-default " href="javascript:void(0)" title="Default Hold Intro">
...
<table className="form" id="table_b4e5_2">
  ...
  <div className="sm-input-shim" tabindex="0">
    ...
    <input id="customivr" name="customivr" type="text" value="ALLISONSMITH_hotel.mp3" className="snappy sm-input sm-item-value-4587129701531648 " tabindex="-1"/>
  </div>
  <div className="sm-menu"><div></div>
    <ul className="sm-list">
        ...
        <li className="sm-item" id="sm-item-customivr-default" data-value="default">
          ...
          <a className="sm-text sm-item-value-default " href="javascript:void(0)" title="Wonderblues">

            Wonderblues
          </a>
        </li>

        <li className="sm-item" id="sm-item-customivr-lighttouch" data-value="lighttouch">

          <a className="sm-text sm-item-value-lighttouch " href="javascript:void(0)" title="Light Touch">

            Light Touch
          </a>
        </li>

        <li className="sm-item" id="sm-item-customivr-blue" data-value="blue">

          <a className="sm-text sm-item-value-blue " href="javascript:void(0)" title="Blue">

            Blue
          </a>
        </li>

        <li className="sm-item" id="sm-item-customivr-sonar" data-value="sonar">

          <a className="sm-text sm-item-value-sonar " href="javascript:void(0)" title="Sonar">

            Sonar
          </a>
        </li>

        <li className="sm-item" id="sm-item-customivr-alex_hold" data-value="alex_hold">

          <a className="sm-text sm-item-value-alex_hold " href="javascript:void(0)" title="I'm On Hold">

            I'm On Hold
          </a>
        </li>

        <li className="sm-item" id="sm-item-customivr-4587129701531648" data-value="4587129701531648">

          <a className="sm-text sm-item-value-4587129701531648 " href="javascript:void(0)" title="ALLISONSMITH_hotel.mp3">
